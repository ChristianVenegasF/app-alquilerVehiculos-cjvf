...
public class frmEditarVehiculo extends javax.swing.JFrame {
    ...
    public frmEditarVehiculo(frmListaVehiculos listaVehiculos, int id, String placa, String marca, String modelo) {
        initComponents();
         this.vehiculoController = new VehiculoController();
        this.idVehiculo = id;
         // 🔹 Llenar los campos con los datos actuales del vehículo
    ...
    // 🔹 Crear un objeto Vehículo con los datos modificados
    Vehiculo vehiculoActualizado = new Vehiculo(idVehiculo, marca, modelo, placa, true);

    // 🔹 Llamar al controlador para actualizar en la base de datos
    if (vehiculoController.actualizarVehiculo(vehiculoActualizado)) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
               //new frmEditarVehiculo().setVisible(false);
            }
        });
    }
